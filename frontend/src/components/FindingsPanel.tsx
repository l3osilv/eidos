...
const LABEL_COLORS = {
  Blood: { positive: 'text-red-700 bg-red-50 border-red-200', negative: 'text-slate-600 bg-slate-50 border-slate-200' },
  Ischemia: { positive: 'text-orange-700 bg-orange-50 border-orange-200', negative: 'text-slate-600 bg-slate-50 border-slate-200' },
  Chronic_Ischemia: { positive: 'text-amber-700 bg-amber-50 border-amber-200', negative: 'text-slate-600 bg-slate-50 border-slate-200' },
  Edema: { positive: 'text-indigo-700 bg-indigo-50 border-indigo-200', negative: 'text-slate-600 bg-slate-50 border-slate-200' },
  Mass: { positive: 'text-purple-700 bg-purple-50 border-purple-200', negative: 'text-slate-600 bg-slate-50 border-slate-200' },
};
        ...
        <div className="space-y-3.5" id="classification-findings-container">
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-[11px] text-slate-800 leading-tight font-sans">
                      {labelLabels[f.label as keyof typeof labelLabels]}
                    </span>
                  </div>
          ...
          {patient.validated && (
            <div className="bg-slate-50 border border-slate-200 rounded p-2.5 flex items-center gap-2 text-[11px] text-slate-500 font-sans mt-2" id="findings-validated-notice">
              ...
              <span>
                L'esame è validato. Per eseguire nuovamente la valutazione e riesaminare le foto TC, il medico strutturato deve prima riaprire il referto.
              </span>
            </div>
          )}
